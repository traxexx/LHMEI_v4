...
void SetAllHetIndex( const char* het_index_name, AllHetIndex & allHetIndex )
{
	using std::getline;
...
// read file
	...
	het_index_file.open( het_index_name );
	CheckInputFileStatus( het_index_file, het_index_name );
	string line;
